...
<div class="selection-group">
  ...
  <el-row class="block-col-1">
    <el-col :span="24">
      <el-dropdown trigger="click" :hide-on-click="true" class="dropdown-toggle menu-btn" @command="handleCommand" placement="bottom-start" popper-class="selection-dropdown-custom">
...
.selection-dropdown-custom .el-dropdown-menu__item {
